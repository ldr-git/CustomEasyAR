...
public class ImageGLView extends GLSurfaceView {
    ...
    private EasyARImageInitializer initializer;
    ...
    public ImageGLView(Context context) {
        super(context);
        if (context instanceof ImageTargetCallback) {
            targetCallback = (ImageTargetCallback) context;
        }
        ...
        this.setRenderer(new GLSurfaceView.Renderer() {
            ...
            public void onSurfaceCreated(GL10 gl, EGLConfig config) {
                if (!initialized) {
                    initialized = true;
                    initializer = new EasyARImageInitializer(targetCallback);
